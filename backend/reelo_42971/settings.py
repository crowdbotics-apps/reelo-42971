"""
Django settings for reelo_42971 project.
...
WSGI_APPLICATION = 'reelo_42971.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "reelo_42971 API",
    "DESCRIPTION": "API documentation for reelo_42971 App",
    "VERSION": "v1",
}
